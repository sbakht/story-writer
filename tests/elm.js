...
var _user$project$Util$containsChar = F2(
	function (str, $char) {
		return A2(
			...
			function (c) {
				return _elm_lang$core$Native_Utils.eq($char, c);
			},
			str);
	});
var _user$project$Util$isPunctuation = _user$project$Util$containsChar(_user$project$Util$punctuation);
var _user$project$Util$toSpace = function (str) {
	return A3(
		_elm_lang$core$String$foldr,
		F2(
			function (c, accum) {
				return _user$project$Util$isPunctuation(c) ? A2(
					_elm_lang$core$String$cons,
					_elm_lang$core$Native_Utils.chr(' '),
					accum) : A2(_elm_lang$core$String$cons, c, accum);
			}),
		'',
		str);
};
var _user$project$Util$contains = F2(
...
var _user$project$Util$isCompletedDictionary = function (_p0) {
	var _p1 = _p0;
	return A2(
		_elm_lang$core$List$all,
		function (word) {
			return A2(
				_user$project$Util$contains,
				word,
				_user$project$Util$toSpace(_p1.line));
		},
		_p1.dictionary);
};
var _user$project$Util$Word = F2(
	function (a, b) {
		return {word: a, details: b};
	});
var _user$project$Util$Definition = F2(
	function (a, b) {
		return {definition: a, partOfSpeech: b};
	});
var _user$project$Util$decodeDefinition = A3(
	...
	A3(
		...
		'definition',
		_elm_lang$core$Json_Decode$string,
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Util$Definition)));
var _user$project$Util$Entry = F2(
	function (a, b) {
...
var _user$project$Tests$mkWord = function (s) {
	return A2(
		...
		{
			ctor: '::',
			_0: A2(_user$project$Util$Definition, '', ''),
			_1: {ctor: '[]'}
		});
};
var _user$project$Tests$word = A2(
	_user$project$Util$Word,
	'cool',
	{
		ctor: '::',
		_0: A2(_user$project$Util$Definition, 'It is me yo', 'noun'),
		_1: {ctor: '[]'}
	});
var _user$project$Tests$myEntry = A2(
	_user$project$Util$Entry,
	'This is cool',
	{
		ctor: '::',
			...
			_0: A2(
				...
				function (_p9) {
					return A2(
						_elm_community$elm_test$Expect$equal,
						true,
						A2(_user$project$Util$contains, _user$project$Tests$word, 'This is cool'));
				}),
			_1: {
				ctor: '::',
				_0: A2(
					...
					function (_p10) {
						return A2(
							_elm_community$elm_test$Expect$equal,
							true,
							_user$project$Util$isCompletedDictionary(
								A2(
									_user$project$Util$Entry,
									'This is cool',
									A2(
										_elm_lang$core$List$map,
										_user$project$Tests$mkWord,
										{
											ctor: '::',
											_0: 'cool',
											_1: {
									...
									return A2(
										...
										_user$project$Util$isCompletedDictionary(
											A2(
												...
												{
													ctor: '::',
													_0: _user$project$Tests$mkWord('cool'),
													_1: {ctor: '[]'}
												})));
								}),
							_1: {
											...
											_0: A2(
												...
												function (_p17) {
													return A2(
														_elm_community$elm_test$Expect$equal,
														'cool ',
														_user$project$Util$toSpace('cool.'));
												}),
											_1: {
												ctor: '::',
												_0: A2(
																	...
																	A2(
																		...
																		A2(
																			...
																			'This is cool',
																			{
																				...
																				_1: {
																					ctor: '::',
																					_0: _user$project$Tests$mkWord('meme'),
																					_1: {ctor: '[]'}
																				}
																			})));
															}),
