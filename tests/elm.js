...
var _user$project$Tests$contains = F2(
...
var _user$project$Tests$Word = F3(
	function (a, b, c) {
		return {word: a, partOfSpeech: b, definition: c};
	});
var _user$project$Tests$word = A3(_user$project$Tests$Word, 'cool', 'noun', 'It is me yo');
			...
			_0: A2(
				...
				function (_p1) {
					return A2(
						_elm_community$elm_test$Expect$equal,
						true,
						A2(_user$project$Tests$contains, _user$project$Tests$word, 'This is cool'));
				}),
			_1: {ctor: '[]'}
		}
	});
